...
read_path = '/media/alxfed/toca/aa-crm/preparation/hubspot-crm-exports-all-companies-2019-08-11.csv'
write_path = '/media/alxfed/toca/aa-crm/preparation/companies_with_phone.csv'
write_excluded_path = '/media/alxfed/toca/aa-crm/preparation/companies_without_phone.csv'
