...
write_path = '/media/alxfed/toca/aa-crm/other-lists/kitchen_and_bath_designers_with_websites.csv'
write_excluded_path = '/media/alxfed/toca/aa-crm/other-lists/kitchen_and_bath_designers_without_websites.csv'
