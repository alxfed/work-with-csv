...
read_path = '/media/alxfed/toca/aa-crm/int-desanddec/int_designers_and_dec.csv'
write_path = '/media/alxfed/toca/aa-crm/int-desanddec/int_designers_and_dec_for_upload.csv'
